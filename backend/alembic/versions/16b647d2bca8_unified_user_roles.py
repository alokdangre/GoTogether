...
def upgrade() -> None:
    ...
    userrole_enum = postgresql.ENUM('RIDER', 'DRIVER', 'BOTH', name='userrole', create_type=False)
    userrole_enum.create(op.get_bind(), checkfirst=True)
    
    ratingparticipanttype_enum = postgresql.ENUM('RIDER', 'DRIVER', name='ratingparticipanttype', create_type=False)
    ratingparticipanttype_enum.create(op.get_bind(), checkfirst=True)
    ...
    op.add_column('users', sa.Column('role', sa.Enum('RIDER', 'DRIVER', 'BOTH', name='userrole'), nullable=True))
    
    # Set default value for existing users
    op.execute("UPDATE users SET role = 'RIDER' WHERE role IS NULL")
